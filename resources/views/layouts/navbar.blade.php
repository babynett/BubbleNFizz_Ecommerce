...
py-6 @endguest">
                @guest
                    ...
                    <div id="dropdownNavbar" class="z-10 hidden font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
                        <ul class="py-2 text-sm text-gray-700 dark:text-gray-400" aria-labelledby="dropdownLargeButton">
                          ...
                          <li>
                            <a href="#" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Bubble</a>
                          </li>
                          <li>
                    ...
                    <a class="relative text-black font-semibold hover:text-amber-500" href="/bubblebath">About Us</a>
                ...
                @auth
                    ...
                    <a class="relative text-black font-semibold hover:text-amber-500" href="#">About Us</a>
                    <a class="relative text-black font-semibold hover:text-amber-500" href="#">Terms and Condition</a>
                    @endif
                @endauth
            </div>
